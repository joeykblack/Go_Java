 ...
 *
 */
public class RndGameAproxMinLossMoveEvaluatorTask implements Runnable
{
	 ...
	 */
	public RndGameAproxMinLossMoveEvaluatorTask(ThreadUpdatableAgent updator,
	...
	public void run()
	{
		updator.updateBestMove(
				MoveEvaluator.randGameApproxMCMinLossScore(originalbs, testRow, testCol, myType, 
															numGames, numApproxRounds, numApproxPieces, 
