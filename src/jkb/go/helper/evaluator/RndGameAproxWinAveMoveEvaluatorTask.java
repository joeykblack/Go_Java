 ...
 *
 */
public class RndGameAproxWinAveMoveEvaluatorTask implements Runnable
{
	 ...
	 */
	public RndGameAproxWinAveMoveEvaluatorTask(ThreadUpdatableAgent updator,
	...
	public void run()
	{
		updator.updateBestMove(
				MoveEvaluator.randGameApproxMCWinRateScore(originalbs, testRow, testCol, myType, 
